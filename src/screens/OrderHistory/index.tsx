...
const OrderHistory = () => {
  ...
  const Pending = () => {
    ...
    // const orderProducts: OrderProductsHistory = allOrders?.reduce(
    //   (acc: OrderHistoryProducts, item: any) => {
    //     const currentId = item.dealId ? item.dealId : item.id;
    //     if (!acc[currentId]) {
    //       if (item?.dealId) {
    //         acc[currentId] = {
    //           ...item,
    //           internalId: item?.dealId,
    //           isDeal: true,
    //           products: [item.product],
    //         };
    //       } else {
    //         acc[currentId] = { internalId: item?.id, isDeal: false, ...item };
    //       }
    //     } else {
    //       acc[currentId] = {
    //         ...acc[currentId],
    //         products: [...acc[currentId].products, item.product],
    //       };
    //     }
    //     return acc;
    //   },
    ...
    console.log("order products are", de);
    return (
  ...
  const Completed = () => {
    ...
    console.log("completed products are", allOrders);
    return (
      <View style={styles.background}>
        {isLoading && <Loader isLoading={isLoading} />}
        <FlatList
